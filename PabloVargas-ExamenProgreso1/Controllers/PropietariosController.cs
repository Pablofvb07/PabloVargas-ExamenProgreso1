...
namespace PabloVargas_ExamenProgreso1.Controllers
{
    public class PropietariosController : Controller
    {
        ...
        public PropietariosController(BaseDeDatosExamenVargas context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,CodigoSeguridad,EstaAfiliado,FechaNacimiento")] Propietario propietario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,CodigoSeguridad,EstaAfiliado,FechaNacimiento")] Propietario propietario)
        {
