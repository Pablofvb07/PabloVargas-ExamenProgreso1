...
namespace PabloVargas_ExamenProgreso1.Controllers
{
    public class MascotasController : Controller
    {
        ...
        public MascotasController(BaseDeDatosExamenVargas context)
        {
            _context = context;
        }
        ...
        {
            var baseDeDatosExamenVargas = _context.Mascota.Include(m => m.Propietario);
            return View(await baseDeDatosExamenVargas.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Raza,Tamaño,TieneVacunas,IdPropietario")] Mascota mascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Raza,Tamaño,TieneVacunas,IdPropietario")] Mascota mascota)
        {
            if (id != mascota.Id)
            {
                return NotFound();
